...
namespace SalaryPolymorphism
{
    ...
    class HourlyEmployee : Employee
    {
        ...
        public HourlyEmployee(string firstName, string lastName, string socialSecurityNumber, decimal hourlyWage, decimal hourlyWorked) : base(firstName, lastName, socialSecurityNumber)
        {
            wage = hourlyWage; // validate hourly wage
            hours = hourlyWorked; //validate hours worked
        }
